Shader "Custom/Glowing/Depthmapped Hologram"{
	...
	Properties{
		...
		_ExtrusionSubtract ("Extrusion Subtract", Range(0,1)) = 0.0
	}
	...
	SubShader{
		...
		Pass{
			...
			v2f vert (appdata v){
				...
				o.vertex = UnityObjectToClipPos(v.vertex + (v.normal * saturate(pow(o.col.r, _ExtrusionPower) - _ExtrusionSubtract) * _Extrusion));
